...
func NewMsgCreateReview(creator string, movieId uint64, rating uint64, description string) *MsgCreateReview {
...
func NewMsgUpdateReview(creator string, id uint64, movieId uint64, rating uint64, description string) *MsgUpdateReview {
